...
namespace test {
	...
	GLuint DynamicBatchIB::LoadTexture(const std::string& texturePath)
	{
	...
	void DynamicBatchIB::OnUpdate(float deltaTime)
	{
	}

	void DynamicBatchIB::OnRender()
	{
	...
	void DynamicBatchIB::OnImGuiRender()
	{
