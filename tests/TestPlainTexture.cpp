...
namespace test {
	TestPlainTexture::TestPlainTexture()
		...
		m_Proj(glm::ortho(0.0f, 960.0f, 0.0f, 540.0f, -1.0f, 1.0f))
	{
		...
		m_Texture = std::make_unique<Texture>("res/textures/menubg.png");
	...
	void TestPlainTexture::OnUpdate(float deltaTime)
	{
	}

	void TestPlainTexture::OnRender()
	{
	...
	void TestPlainTexture::OnImGuiRender()
	{
