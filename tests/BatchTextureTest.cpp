...
namespace test {
	...
	{
		float positions[] = {
			-150.0f,  -50.0f, 0.0f, 0.18f, 0.6f, 0.96f, 1.0f, 0.0f, 0.0f,		//0
			 -50.0f,  -50.0f, 1.0f, 0.18f, 0.6f, 0.96f, 1.0f, 1.0f, 0.0f,		//1
			 -50.0f,   50.0f, 1.0f, 0.18f, 0.6f, 0.96f, 1.0f, 1.0f, 1.0f,		//2
			-150.0f,   50.0f, 0.0f, 0.18f, 0.6f, 0.96f, 1.0f, 0.0f, 1.0f,		//3

			  50.0f,  -50.0f, 0.0f, 1.0f, 0.93f, 0.24f, 1.0f, 0.0f, 0.0f,		//4
			 150.0f,  -50.0f, 1.0f, 1.0f, 0.93f, 0.24f, 1.0f, 1.0f, 0.0f,		//5
			 150.0f,   50.0f, 1.0f, 1.0f, 0.93f, 0.24f, 1.0f, 1.0f, 1.0f,		//6
			  50.0f,   50.0f, 0.0f, 1.0f, 0.93f, 0.24f, 1.0f, 0.0f, 1.0f		//7
		};
		...
		m_VertexBuffer = std::make_unique<VertexBuffer>(positions, 2 * (4 * 9 * sizeof(float)));
