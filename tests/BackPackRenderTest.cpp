...
namespace test {
	BackPackRenderTest::BackPackRenderTest()
	{
	...
	GLuint BackPackRenderTest::LoadTexture(const std::string& texturePath)
	{
	...
	void BackPackRenderTest::Init()
	{
	}

	void BackPackRenderTest::OnUpdate(float deltaTime)
	{
	...
	void BackPackRenderTest::OnRender()
	{
	...
	void BackPackRenderTest::OnImGuiRender()
	{
	...
	// ---------------------------------------------------------------------------------------------
	void BackPackRenderTest::framebuffer_size_callback(GLFWwindow* window, int width, int height)
	{
	...
	// ---------------------------------------------------------------------------------------------------------
	void BackPackRenderTest::ProcessInput()
	{
	...
	// -------------------------------------------------------
	void BackPackRenderTest::mouse_callback(GLFWwindow* window, double xposIn, double yposIn)
	{
	...
	// ----------------------------------------------------------------------
	void BackPackRenderTest::scroll_callback(GLFWwindow* window, double xoffset, double yoffset)
	{
